package com.vela.assistant.presentation.common.theme
...
// Vela always renders in the custom dark scheme regardless of system setting — the brand
...
fun VelaTheme(
    ...
    val colorScheme = VelaColorScheme
