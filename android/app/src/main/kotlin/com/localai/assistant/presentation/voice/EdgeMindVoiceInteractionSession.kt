...
import com.localai.assistant.R
...
// gesture) once EdgeMind is the device's default Assistant. The "wake word" is the system
...
class EdgeMindVoiceInteractionSession(
    context: Context,
